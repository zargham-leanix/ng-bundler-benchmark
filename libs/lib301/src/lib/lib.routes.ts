...
import { Lib301Component } from './lib301/lib301.component';
import { lib1301Routes } from '@ng-bundler-benchmark/lib1301';
...
export const lib301Routes: Route[] = [
    { path: 'lib1301', children: lib1301Routes },
  { path: '', component: Lib301Component },

...
import { Lib261Component } from './lib261/lib261.component';
import { lib1261Routes } from '@ng-bundler-benchmark/lib1261';
...
export const lib261Routes: Route[] = [
    { path: 'lib1261', children: lib1261Routes },
  { path: '', component: Lib261Component },

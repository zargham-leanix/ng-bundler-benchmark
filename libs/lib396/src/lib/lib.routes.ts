...
import { Lib396Component } from './lib396/lib396.component';
import { lib1396Routes } from '@ng-bundler-benchmark/lib1396';
...
export const lib396Routes: Route[] = [
    { path: 'lib1396', children: lib1396Routes },
  { path: '', component: Lib396Component },

...
import { Lib297Component } from './lib297/lib297.component';
import { lib1297Routes } from '@ng-bundler-benchmark/lib1297';
...
export const lib297Routes: Route[] = [
    { path: 'lib1297', children: lib1297Routes },
  { path: '', component: Lib297Component },

...
import { Lib352Component } from './lib352/lib352.component';
import { lib1352Routes } from '@ng-bundler-benchmark/lib1352';
...
export const lib352Routes: Route[] = [
    { path: 'lib1352', children: lib1352Routes },
  { path: '', component: Lib352Component },

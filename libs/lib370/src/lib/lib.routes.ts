...
import { Lib370Component } from './lib370/lib370.component';
import { lib1370Routes } from '@ng-bundler-benchmark/lib1370';
...
export const lib370Routes: Route[] = [
    { path: 'lib1370', children: lib1370Routes },
  { path: '', component: Lib370Component },

...
import { Lib342Component } from './lib342/lib342.component';
import { lib1342Routes } from '@ng-bundler-benchmark/lib1342';
...
export const lib342Routes: Route[] = [
    { path: 'lib1342', children: lib1342Routes },
  { path: '', component: Lib342Component },

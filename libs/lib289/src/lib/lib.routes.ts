...
import { Lib289Component } from './lib289/lib289.component';
import { lib1289Routes } from '@ng-bundler-benchmark/lib1289';
...
export const lib289Routes: Route[] = [
    { path: 'lib1289', children: lib1289Routes },
  { path: '', component: Lib289Component },

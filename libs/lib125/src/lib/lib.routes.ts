...
import { Lib125Component } from './lib125/lib125.component';
import { lib1125Routes } from '@ng-bundler-benchmark/lib1125';
...
export const lib125Routes: Route[] = [
    { path: 'lib1125', children: lib1125Routes },
  { path: '', component: Lib125Component },

...
import { Lib219Component } from './lib219/lib219.component';
import { lib1219Routes } from '@ng-bundler-benchmark/lib1219';
...
export const lib219Routes: Route[] = [
    { path: 'lib1219', children: lib1219Routes },
  { path: '', component: Lib219Component },

...
import { Lib129Component } from './lib129/lib129.component';
import { lib1129Routes } from '@ng-bundler-benchmark/lib1129';
...
export const lib129Routes: Route[] = [
    { path: 'lib1129', children: lib1129Routes },
  { path: '', component: Lib129Component },

...
import { Lib229Component } from './lib229/lib229.component';
import { lib1229Routes } from '@ng-bundler-benchmark/lib1229';
...
export const lib229Routes: Route[] = [
    { path: 'lib1229', children: lib1229Routes },
  { path: '', component: Lib229Component },

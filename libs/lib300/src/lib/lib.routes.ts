...
import { Lib300Component } from './lib300/lib300.component';
import { lib1300Routes } from '@ng-bundler-benchmark/lib1300';
...
export const lib300Routes: Route[] = [
    { path: 'lib1300', children: lib1300Routes },
  { path: '', component: Lib300Component },

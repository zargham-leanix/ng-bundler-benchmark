...
import { Lib214Component } from './lib214/lib214.component';
import { lib1214Routes } from '@ng-bundler-benchmark/lib1214';
...
export const lib214Routes: Route[] = [
    { path: 'lib1214', children: lib1214Routes },
  { path: '', component: Lib214Component },

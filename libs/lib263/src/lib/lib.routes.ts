...
import { Lib263Component } from './lib263/lib263.component';
import { lib1263Routes } from '@ng-bundler-benchmark/lib1263';
...
export const lib263Routes: Route[] = [
    { path: 'lib1263', children: lib1263Routes },
  { path: '', component: Lib263Component },

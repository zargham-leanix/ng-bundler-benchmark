...
import { Lib373Component } from './lib373/lib373.component';
import { lib1373Routes } from '@ng-bundler-benchmark/lib1373';
...
export const lib373Routes: Route[] = [
    { path: 'lib1373', children: lib1373Routes },
  { path: '', component: Lib373Component },

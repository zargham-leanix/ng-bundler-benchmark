...
import { Lib404Component } from './lib404/lib404.component';
import { lib1404Routes } from '@ng-bundler-benchmark/lib1404';
...
export const lib404Routes: Route[] = [
    { path: 'lib1404', children: lib1404Routes },
  { path: '', component: Lib404Component },

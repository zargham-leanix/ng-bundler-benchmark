...
import { Lib152Component } from './lib152/lib152.component';
import { lib1152Routes } from '@ng-bundler-benchmark/lib1152';
...
export const lib152Routes: Route[] = [
    { path: 'lib1152', children: lib1152Routes },
  { path: '', component: Lib152Component },

...
import { Lib291Component } from './lib291/lib291.component';
import { lib1291Routes } from '@ng-bundler-benchmark/lib1291';
...
export const lib291Routes: Route[] = [
    { path: 'lib1291', children: lib1291Routes },
  { path: '', component: Lib291Component },

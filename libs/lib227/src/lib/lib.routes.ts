...
import { Lib227Component } from './lib227/lib227.component';
import { lib1227Routes } from '@ng-bundler-benchmark/lib1227';
...
export const lib227Routes: Route[] = [
    { path: 'lib1227', children: lib1227Routes },
  { path: '', component: Lib227Component },

...
import { Lib91Component } from './lib91/lib91.component';
import { lib1091Routes } from '@ng-bundler-benchmark/lib1091';
...
export const lib91Routes: Route[] = [
    { path: 'lib1091', children: lib1091Routes },
  { path: '', component: Lib91Component },

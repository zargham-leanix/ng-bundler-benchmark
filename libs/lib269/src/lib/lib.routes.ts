...
import { Lib269Component } from './lib269/lib269.component';
import { lib1269Routes } from '@ng-bundler-benchmark/lib1269';
...
export const lib269Routes: Route[] = [
    { path: 'lib1269', children: lib1269Routes },
  { path: '', component: Lib269Component },

...
import { Lib120Component } from './lib120/lib120.component';
import { lib1120Routes } from '@ng-bundler-benchmark/lib1120';
...
export const lib120Routes: Route[] = [
    { path: 'lib1120', children: lib1120Routes },
  { path: '', component: Lib120Component },

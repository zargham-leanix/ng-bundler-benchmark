...
import { Lib147Component } from './lib147/lib147.component';
import { lib1147Routes } from '@ng-bundler-benchmark/lib1147';
...
export const lib147Routes: Route[] = [
    { path: 'lib1147', children: lib1147Routes },
  { path: '', component: Lib147Component },

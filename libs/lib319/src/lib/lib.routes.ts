...
import { Lib319Component } from './lib319/lib319.component';
import { lib1319Routes } from '@ng-bundler-benchmark/lib1319';
...
export const lib319Routes: Route[] = [
    { path: 'lib1319', children: lib1319Routes },
  { path: '', component: Lib319Component },

...
import { Lib185Component } from './lib185/lib185.component';
import { lib1185Routes } from '@ng-bundler-benchmark/lib1185';
...
export const lib185Routes: Route[] = [
    { path: 'lib1185', children: lib1185Routes },
  { path: '', component: Lib185Component },

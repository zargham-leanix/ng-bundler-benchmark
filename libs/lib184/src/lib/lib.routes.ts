...
import { Lib184Component } from './lib184/lib184.component';
import { lib1184Routes } from '@ng-bundler-benchmark/lib1184';
...
export const lib184Routes: Route[] = [
    { path: 'lib1184', children: lib1184Routes },
  { path: '', component: Lib184Component },

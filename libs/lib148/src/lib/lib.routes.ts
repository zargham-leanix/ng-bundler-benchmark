...
import { Lib148Component } from './lib148/lib148.component';
import { lib1148Routes } from '@ng-bundler-benchmark/lib1148';
...
export const lib148Routes: Route[] = [
    { path: 'lib1148', children: lib1148Routes },
  { path: '', component: Lib148Component },

...
import { Lib247Component } from './lib247/lib247.component';
import { lib1247Routes } from '@ng-bundler-benchmark/lib1247';
...
export const lib247Routes: Route[] = [
    { path: 'lib1247', children: lib1247Routes },
  { path: '', component: Lib247Component },

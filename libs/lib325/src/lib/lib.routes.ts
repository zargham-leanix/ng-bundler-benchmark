...
import { Lib325Component } from './lib325/lib325.component';
import { lib1325Routes } from '@ng-bundler-benchmark/lib1325';
...
export const lib325Routes: Route[] = [
    { path: 'lib1325', children: lib1325Routes },
  { path: '', component: Lib325Component },

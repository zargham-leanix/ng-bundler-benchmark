...
import { Lib200Component } from './lib200/lib200.component';
import { lib1200Routes } from '@ng-bundler-benchmark/lib1200';
...
export const lib200Routes: Route[] = [
    { path: 'lib1200', children: lib1200Routes },
  { path: '', component: Lib200Component },

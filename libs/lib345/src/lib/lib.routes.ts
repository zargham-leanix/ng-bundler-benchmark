...
import { Lib345Component } from './lib345/lib345.component';
import { lib1345Routes } from '@ng-bundler-benchmark/lib1345';
...
export const lib345Routes: Route[] = [
    { path: 'lib1345', children: lib1345Routes },
  { path: '', component: Lib345Component },

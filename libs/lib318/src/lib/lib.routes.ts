...
import { Lib318Component } from './lib318/lib318.component';
import { lib1318Routes } from '@ng-bundler-benchmark/lib1318';
...
export const lib318Routes: Route[] = [
    { path: 'lib1318', children: lib1318Routes },
  { path: '', component: Lib318Component },

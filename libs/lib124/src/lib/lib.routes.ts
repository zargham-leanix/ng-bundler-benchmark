...
import { Lib124Component } from './lib124/lib124.component';
import { lib1124Routes } from '@ng-bundler-benchmark/lib1124';
...
export const lib124Routes: Route[] = [
    { path: 'lib1124', children: lib1124Routes },
  { path: '', component: Lib124Component },

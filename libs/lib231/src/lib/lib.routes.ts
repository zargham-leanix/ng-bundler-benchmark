...
import { Lib231Component } from './lib231/lib231.component';
import { lib1231Routes } from '@ng-bundler-benchmark/lib1231';
...
export const lib231Routes: Route[] = [
    { path: 'lib1231', children: lib1231Routes },
  { path: '', component: Lib231Component },

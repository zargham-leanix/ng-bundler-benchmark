...
import { Lib341Component } from './lib341/lib341.component';
import { lib1341Routes } from '@ng-bundler-benchmark/lib1341';
...
export const lib341Routes: Route[] = [
    { path: 'lib1341', children: lib1341Routes },
  { path: '', component: Lib341Component },

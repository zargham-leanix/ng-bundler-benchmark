...
import { Lib186Component } from './lib186/lib186.component';
import { lib1186Routes } from '@ng-bundler-benchmark/lib1186';
...
export const lib186Routes: Route[] = [
    { path: 'lib1186', children: lib1186Routes },
  { path: '', component: Lib186Component },

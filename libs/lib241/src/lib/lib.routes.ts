...
import { Lib241Component } from './lib241/lib241.component';
import { lib1241Routes } from '@ng-bundler-benchmark/lib1241';
...
export const lib241Routes: Route[] = [
    { path: 'lib1241', children: lib1241Routes },
  { path: '', component: Lib241Component },

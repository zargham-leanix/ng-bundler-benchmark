...
import { Lib159Component } from './lib159/lib159.component';
import { lib1159Routes } from '@ng-bundler-benchmark/lib1159';
...
export const lib159Routes: Route[] = [
    { path: 'lib1159', children: lib1159Routes },
  { path: '', component: Lib159Component },

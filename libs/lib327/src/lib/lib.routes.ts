...
import { Lib327Component } from './lib327/lib327.component';
import { lib1327Routes } from '@ng-bundler-benchmark/lib1327';
...
export const lib327Routes: Route[] = [
    { path: 'lib1327', children: lib1327Routes },
  { path: '', component: Lib327Component },

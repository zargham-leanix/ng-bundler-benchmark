...
import { Lib361Component } from './lib361/lib361.component';
import { lib1361Routes } from '@ng-bundler-benchmark/lib1361';
...
export const lib361Routes: Route[] = [
    { path: 'lib1361', children: lib1361Routes },
  { path: '', component: Lib361Component },

...
import { Lib348Component } from './lib348/lib348.component';
import { lib1348Routes } from '@ng-bundler-benchmark/lib1348';
...
export const lib348Routes: Route[] = [
    { path: 'lib1348', children: lib1348Routes },
  { path: '', component: Lib348Component },

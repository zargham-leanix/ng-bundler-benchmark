...
import { Lib140Component } from './lib140/lib140.component';
import { lib1140Routes } from '@ng-bundler-benchmark/lib1140';
...
export const lib140Routes: Route[] = [
    { path: 'lib1140', children: lib1140Routes },
  { path: '', component: Lib140Component },

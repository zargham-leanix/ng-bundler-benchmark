...
import { Lib394Component } from './lib394/lib394.component';
import { lib1394Routes } from '@ng-bundler-benchmark/lib1394';
...
export const lib394Routes: Route[] = [
    { path: 'lib1394', children: lib1394Routes },
  { path: '', component: Lib394Component },

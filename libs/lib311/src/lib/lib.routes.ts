...
import { Lib311Component } from './lib311/lib311.component';
import { lib1311Routes } from '@ng-bundler-benchmark/lib1311';
...
export const lib311Routes: Route[] = [
    { path: 'lib1311', children: lib1311Routes },
  { path: '', component: Lib311Component },

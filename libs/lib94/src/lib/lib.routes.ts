...
import { Lib94Component } from './lib94/lib94.component';
import { lib1094Routes } from '@ng-bundler-benchmark/lib1094';
...
export const lib94Routes: Route[] = [
    { path: 'lib1094', children: lib1094Routes },
  { path: '', component: Lib94Component },

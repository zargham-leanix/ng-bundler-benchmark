...
import { Lib249Component } from './lib249/lib249.component';
import { lib1249Routes } from '@ng-bundler-benchmark/lib1249';
...
export const lib249Routes: Route[] = [
    { path: 'lib1249', children: lib1249Routes },
  { path: '', component: Lib249Component },

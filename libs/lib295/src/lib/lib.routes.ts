...
import { Lib295Component } from './lib295/lib295.component';
import { lib1295Routes } from '@ng-bundler-benchmark/lib1295';
...
export const lib295Routes: Route[] = [
    { path: 'lib1295', children: lib1295Routes },
  { path: '', component: Lib295Component },

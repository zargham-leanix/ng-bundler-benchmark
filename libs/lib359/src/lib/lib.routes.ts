...
import { Lib359Component } from './lib359/lib359.component';
import { lib1359Routes } from '@ng-bundler-benchmark/lib1359';
...
export const lib359Routes: Route[] = [
    { path: 'lib1359', children: lib1359Routes },
  { path: '', component: Lib359Component },

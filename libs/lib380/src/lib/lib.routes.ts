...
import { Lib380Component } from './lib380/lib380.component';
import { lib1380Routes } from '@ng-bundler-benchmark/lib1380';
...
export const lib380Routes: Route[] = [
    { path: 'lib1380', children: lib1380Routes },
  { path: '', component: Lib380Component },

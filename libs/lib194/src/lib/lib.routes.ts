...
import { Lib194Component } from './lib194/lib194.component';
import { lib1194Routes } from '@ng-bundler-benchmark/lib1194';
...
export const lib194Routes: Route[] = [
    { path: 'lib1194', children: lib1194Routes },
  { path: '', component: Lib194Component },

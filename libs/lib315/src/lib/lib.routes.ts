...
import { Lib315Component } from './lib315/lib315.component';
import { lib1315Routes } from '@ng-bundler-benchmark/lib1315';
...
export const lib315Routes: Route[] = [
    { path: 'lib1315', children: lib1315Routes },
  { path: '', component: Lib315Component },

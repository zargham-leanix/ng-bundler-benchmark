...
import { Lib245Component } from './lib245/lib245.component';
import { lib1245Routes } from '@ng-bundler-benchmark/lib1245';
...
export const lib245Routes: Route[] = [
    { path: 'lib1245', children: lib1245Routes },
  { path: '', component: Lib245Component },

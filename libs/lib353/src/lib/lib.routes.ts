...
import { Lib353Component } from './lib353/lib353.component';
import { lib1353Routes } from '@ng-bundler-benchmark/lib1353';
...
export const lib353Routes: Route[] = [
    { path: 'lib1353', children: lib1353Routes },
  { path: '', component: Lib353Component },

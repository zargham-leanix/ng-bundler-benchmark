...
import { Lib270Component } from './lib270/lib270.component';
import { lib1270Routes } from '@ng-bundler-benchmark/lib1270';
...
export const lib270Routes: Route[] = [
    { path: 'lib1270', children: lib1270Routes },
  { path: '', component: Lib270Component },

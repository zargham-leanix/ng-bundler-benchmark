...
import { Lib320Component } from './lib320/lib320.component';
import { lib1320Routes } from '@ng-bundler-benchmark/lib1320';
...
export const lib320Routes: Route[] = [
    { path: 'lib1320', children: lib1320Routes },
  { path: '', component: Lib320Component },

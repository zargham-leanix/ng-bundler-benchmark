...
import { Lib201Component } from './lib201/lib201.component';
import { lib1201Routes } from '@ng-bundler-benchmark/lib1201';
...
export const lib201Routes: Route[] = [
    { path: 'lib1201', children: lib1201Routes },
  { path: '', component: Lib201Component },

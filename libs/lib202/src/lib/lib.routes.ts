...
import { Lib202Component } from './lib202/lib202.component';
import { lib1202Routes } from '@ng-bundler-benchmark/lib1202';
...
export const lib202Routes: Route[] = [
    { path: 'lib1202', children: lib1202Routes },
  { path: '', component: Lib202Component },

...
import { Lib405Component } from './lib405/lib405.component';
import { lib1405Routes } from '@ng-bundler-benchmark/lib1405';
...
export const lib405Routes: Route[] = [
    { path: 'lib1405', children: lib1405Routes },
  { path: '', component: Lib405Component },

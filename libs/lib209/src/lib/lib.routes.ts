...
import { Lib209Component } from './lib209/lib209.component';
import { lib1209Routes } from '@ng-bundler-benchmark/lib1209';
...
export const lib209Routes: Route[] = [
    { path: 'lib1209', children: lib1209Routes },
  { path: '', component: Lib209Component },

...
import { Lib174Component } from './lib174/lib174.component';
import { lib1174Routes } from '@ng-bundler-benchmark/lib1174';
...
export const lib174Routes: Route[] = [
    { path: 'lib1174', children: lib1174Routes },
  { path: '', component: Lib174Component },

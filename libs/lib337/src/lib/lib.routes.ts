...
import { Lib337Component } from './lib337/lib337.component';
import { lib1337Routes } from '@ng-bundler-benchmark/lib1337';
...
export const lib337Routes: Route[] = [
    { path: 'lib1337', children: lib1337Routes },
  { path: '', component: Lib337Component },

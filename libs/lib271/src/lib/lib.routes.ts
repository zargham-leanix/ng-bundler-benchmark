...
import { Lib271Component } from './lib271/lib271.component';
import { lib1271Routes } from '@ng-bundler-benchmark/lib1271';
...
export const lib271Routes: Route[] = [
    { path: 'lib1271', children: lib1271Routes },
  { path: '', component: Lib271Component },

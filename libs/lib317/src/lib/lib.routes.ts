...
import { Lib317Component } from './lib317/lib317.component';
import { lib1317Routes } from '@ng-bundler-benchmark/lib1317';
...
export const lib317Routes: Route[] = [
    { path: 'lib1317', children: lib1317Routes },
  { path: '', component: Lib317Component },

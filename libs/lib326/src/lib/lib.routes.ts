...
import { Lib326Component } from './lib326/lib326.component';
import { lib1326Routes } from '@ng-bundler-benchmark/lib1326';
...
export const lib326Routes: Route[] = [
    { path: 'lib1326', children: lib1326Routes },
  { path: '', component: Lib326Component },

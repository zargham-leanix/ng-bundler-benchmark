...
import { Lib160Component } from './lib160/lib160.component';
import { lib1160Routes } from '@ng-bundler-benchmark/lib1160';
...
export const lib160Routes: Route[] = [
    { path: 'lib1160', children: lib1160Routes },
  { path: '', component: Lib160Component },

...
import { Lib287Component } from './lib287/lib287.component';
import { lib1287Routes } from '@ng-bundler-benchmark/lib1287';
...
export const lib287Routes: Route[] = [
    { path: 'lib1287', children: lib1287Routes },
  { path: '', component: Lib287Component },

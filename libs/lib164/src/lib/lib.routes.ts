...
import { Lib164Component } from './lib164/lib164.component';
import { lib1164Routes } from '@ng-bundler-benchmark/lib1164';
...
export const lib164Routes: Route[] = [
    { path: 'lib1164', children: lib1164Routes },
  { path: '', component: Lib164Component },

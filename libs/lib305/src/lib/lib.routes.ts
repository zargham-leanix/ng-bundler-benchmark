...
import { Lib305Component } from './lib305/lib305.component';
import { lib1305Routes } from '@ng-bundler-benchmark/lib1305';
...
export const lib305Routes: Route[] = [
    { path: 'lib1305', children: lib1305Routes },
  { path: '', component: Lib305Component },

...
import { Lib198Component } from './lib198/lib198.component';
import { lib1198Routes } from '@ng-bundler-benchmark/lib1198';
...
export const lib198Routes: Route[] = [
    { path: 'lib1198', children: lib1198Routes },
  { path: '', component: Lib198Component },

...
import { Lib109Component } from './lib109/lib109.component';
import { lib1109Routes } from '@ng-bundler-benchmark/lib1109';
...
export const lib109Routes: Route[] = [
    { path: 'lib1109', children: lib1109Routes },
  { path: '', component: Lib109Component },

...
import { Lib375Component } from './lib375/lib375.component';
import { lib1375Routes } from '@ng-bundler-benchmark/lib1375';
...
export const lib375Routes: Route[] = [
    { path: 'lib1375', children: lib1375Routes },
  { path: '', component: Lib375Component },

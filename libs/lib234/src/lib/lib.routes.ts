...
import { Lib234Component } from './lib234/lib234.component';
import { lib1234Routes } from '@ng-bundler-benchmark/lib1234';
...
export const lib234Routes: Route[] = [
    { path: 'lib1234', children: lib1234Routes },
  { path: '', component: Lib234Component },

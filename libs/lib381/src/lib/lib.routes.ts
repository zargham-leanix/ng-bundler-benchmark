...
import { Lib381Component } from './lib381/lib381.component';
import { lib1381Routes } from '@ng-bundler-benchmark/lib1381';
...
export const lib381Routes: Route[] = [
    { path: 'lib1381', children: lib1381Routes },
  { path: '', component: Lib381Component },

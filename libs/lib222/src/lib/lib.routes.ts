...
import { Lib222Component } from './lib222/lib222.component';
import { lib1222Routes } from '@ng-bundler-benchmark/lib1222';
...
export const lib222Routes: Route[] = [
    { path: 'lib1222', children: lib1222Routes },
  { path: '', component: Lib222Component },

...
import { Lib175Component } from './lib175/lib175.component';
import { lib1175Routes } from '@ng-bundler-benchmark/lib1175';
...
export const lib175Routes: Route[] = [
    { path: 'lib1175', children: lib1175Routes },
  { path: '', component: Lib175Component },

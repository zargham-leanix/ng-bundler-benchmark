...
import { Lib310Component } from './lib310/lib310.component';
import { lib1310Routes } from '@ng-bundler-benchmark/lib1310';
...
export const lib310Routes: Route[] = [
    { path: 'lib1310', children: lib1310Routes },
  { path: '', component: Lib310Component },

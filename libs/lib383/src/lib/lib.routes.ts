...
import { Lib383Component } from './lib383/lib383.component';
import { lib1383Routes } from '@ng-bundler-benchmark/lib1383';
...
export const lib383Routes: Route[] = [
    { path: 'lib1383', children: lib1383Routes },
  { path: '', component: Lib383Component },

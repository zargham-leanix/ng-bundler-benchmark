...
import { Lib138Component } from './lib138/lib138.component';
import { lib1138Routes } from '@ng-bundler-benchmark/lib1138';
...
export const lib138Routes: Route[] = [
    { path: 'lib1138', children: lib1138Routes },
  { path: '', component: Lib138Component },

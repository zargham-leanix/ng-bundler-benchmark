...
import { Lib250Component } from './lib250/lib250.component';
import { lib1250Routes } from '@ng-bundler-benchmark/lib1250';
...
export const lib250Routes: Route[] = [
    { path: 'lib1250', children: lib1250Routes },
  { path: '', component: Lib250Component },

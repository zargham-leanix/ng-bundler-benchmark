...
import { Lib226Component } from './lib226/lib226.component';
import { lib1226Routes } from '@ng-bundler-benchmark/lib1226';
...
export const lib226Routes: Route[] = [
    { path: 'lib1226', children: lib1226Routes },
  { path: '', component: Lib226Component },

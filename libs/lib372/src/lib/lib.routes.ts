...
import { Lib372Component } from './lib372/lib372.component';
import { lib1372Routes } from '@ng-bundler-benchmark/lib1372';
...
export const lib372Routes: Route[] = [
    { path: 'lib1372', children: lib1372Routes },
  { path: '', component: Lib372Component },

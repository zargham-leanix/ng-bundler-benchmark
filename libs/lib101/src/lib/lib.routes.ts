...
import { Lib101Component } from './lib101/lib101.component';
import { lib1101Routes } from '@ng-bundler-benchmark/lib1101';
...
export const lib101Routes: Route[] = [
    { path: 'lib1101', children: lib1101Routes },
  { path: '', component: Lib101Component },

...
import { Lib199Component } from './lib199/lib199.component';
import { lib1199Routes } from '@ng-bundler-benchmark/lib1199';
...
export const lib199Routes: Route[] = [
    { path: 'lib1199', children: lib1199Routes },
  { path: '', component: Lib199Component },

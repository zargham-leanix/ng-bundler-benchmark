...
import { Lib328Component } from './lib328/lib328.component';
import { lib1328Routes } from '@ng-bundler-benchmark/lib1328';
...
export const lib328Routes: Route[] = [
    { path: 'lib1328', children: lib1328Routes },
  { path: '', component: Lib328Component },

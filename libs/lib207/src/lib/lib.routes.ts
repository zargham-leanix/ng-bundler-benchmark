...
import { Lib207Component } from './lib207/lib207.component';
import { lib1207Routes } from '@ng-bundler-benchmark/lib1207';
...
export const lib207Routes: Route[] = [
    { path: 'lib1207', children: lib1207Routes },
  { path: '', component: Lib207Component },

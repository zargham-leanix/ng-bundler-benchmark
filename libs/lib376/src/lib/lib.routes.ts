...
import { Lib376Component } from './lib376/lib376.component';
import { lib1376Routes } from '@ng-bundler-benchmark/lib1376';
...
export const lib376Routes: Route[] = [
    { path: 'lib1376', children: lib1376Routes },
  { path: '', component: Lib376Component },

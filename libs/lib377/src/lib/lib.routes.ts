...
import { Lib377Component } from './lib377/lib377.component';
import { lib1377Routes } from '@ng-bundler-benchmark/lib1377';
...
export const lib377Routes: Route[] = [
    { path: 'lib1377', children: lib1377Routes },
  { path: '', component: Lib377Component },

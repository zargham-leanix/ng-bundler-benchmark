...
import { Lib332Component } from './lib332/lib332.component';
import { lib1332Routes } from '@ng-bundler-benchmark/lib1332';
...
export const lib332Routes: Route[] = [
    { path: 'lib1332', children: lib1332Routes },
  { path: '', component: Lib332Component },

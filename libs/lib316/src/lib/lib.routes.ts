...
import { Lib316Component } from './lib316/lib316.component';
import { lib1316Routes } from '@ng-bundler-benchmark/lib1316';
...
export const lib316Routes: Route[] = [
    { path: 'lib1316', children: lib1316Routes },
  { path: '', component: Lib316Component },

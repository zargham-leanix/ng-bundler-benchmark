...
import { Lib339Component } from './lib339/lib339.component';
import { lib1339Routes } from '@ng-bundler-benchmark/lib1339';
...
export const lib339Routes: Route[] = [
    { path: 'lib1339', children: lib1339Routes },
  { path: '', component: Lib339Component },

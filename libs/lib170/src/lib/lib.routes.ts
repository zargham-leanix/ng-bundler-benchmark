...
import { Lib170Component } from './lib170/lib170.component';
import { lib1170Routes } from '@ng-bundler-benchmark/lib1170';
...
export const lib170Routes: Route[] = [
    { path: 'lib1170', children: lib1170Routes },
  { path: '', component: Lib170Component },

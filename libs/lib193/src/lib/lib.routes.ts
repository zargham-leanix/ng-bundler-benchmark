...
import { Lib193Component } from './lib193/lib193.component';
import { lib1193Routes } from '@ng-bundler-benchmark/lib1193';
...
export const lib193Routes: Route[] = [
    { path: 'lib1193', children: lib1193Routes },
  { path: '', component: Lib193Component },

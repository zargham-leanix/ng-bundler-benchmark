...
import { Lib282Component } from './lib282/lib282.component';
import { lib1282Routes } from '@ng-bundler-benchmark/lib1282';
...
export const lib282Routes: Route[] = [
    { path: 'lib1282', children: lib1282Routes },
  { path: '', component: Lib282Component },

...
import { Lib116Component } from './lib116/lib116.component';
import { lib1116Routes } from '@ng-bundler-benchmark/lib1116';
...
export const lib116Routes: Route[] = [
    { path: 'lib1116', children: lib1116Routes },
  { path: '', component: Lib116Component },

...
import { Lib118Component } from './lib118/lib118.component';
import { lib1118Routes } from '@ng-bundler-benchmark/lib1118';
...
export const lib118Routes: Route[] = [
    { path: 'lib1118', children: lib1118Routes },
  { path: '', component: Lib118Component },

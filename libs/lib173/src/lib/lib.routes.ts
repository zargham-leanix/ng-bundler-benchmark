...
import { Lib173Component } from './lib173/lib173.component';
import { lib1173Routes } from '@ng-bundler-benchmark/lib1173';
...
export const lib173Routes: Route[] = [
    { path: 'lib1173', children: lib1173Routes },
  { path: '', component: Lib173Component },

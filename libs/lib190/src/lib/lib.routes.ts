...
import { Lib190Component } from './lib190/lib190.component';
import { lib1190Routes } from '@ng-bundler-benchmark/lib1190';
...
export const lib190Routes: Route[] = [
    { path: 'lib1190', children: lib1190Routes },
  { path: '', component: Lib190Component },

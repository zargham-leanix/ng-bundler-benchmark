...
import { Lib188Component } from './lib188/lib188.component';
import { lib1188Routes } from '@ng-bundler-benchmark/lib1188';
...
export const lib188Routes: Route[] = [
    { path: 'lib1188', children: lib1188Routes },
  { path: '', component: Lib188Component },

...
import { Lib371Component } from './lib371/lib371.component';
import { lib1371Routes } from '@ng-bundler-benchmark/lib1371';
...
export const lib371Routes: Route[] = [
    { path: 'lib1371', children: lib1371Routes },
  { path: '', component: Lib371Component },

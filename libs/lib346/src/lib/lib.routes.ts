...
import { Lib346Component } from './lib346/lib346.component';
import { lib1346Routes } from '@ng-bundler-benchmark/lib1346';
...
export const lib346Routes: Route[] = [
    { path: 'lib1346', children: lib1346Routes },
  { path: '', component: Lib346Component },

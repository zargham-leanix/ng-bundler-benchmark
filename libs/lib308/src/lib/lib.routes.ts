...
import { Lib308Component } from './lib308/lib308.component';
import { lib1308Routes } from '@ng-bundler-benchmark/lib1308';
...
export const lib308Routes: Route[] = [
    { path: 'lib1308', children: lib1308Routes },
  { path: '', component: Lib308Component },

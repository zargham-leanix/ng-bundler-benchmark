...
import { Lib255Component } from './lib255/lib255.component';
import { lib1255Routes } from '@ng-bundler-benchmark/lib1255';
...
export const lib255Routes: Route[] = [
    { path: 'lib1255', children: lib1255Routes },
  { path: '', component: Lib255Component },

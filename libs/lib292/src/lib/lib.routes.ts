...
import { Lib292Component } from './lib292/lib292.component';
import { lib1292Routes } from '@ng-bundler-benchmark/lib1292';
...
export const lib292Routes: Route[] = [
    { path: 'lib1292', children: lib1292Routes },
  { path: '', component: Lib292Component },

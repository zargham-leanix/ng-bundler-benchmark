...
import { Lib105Component } from './lib105/lib105.component';
import { lib1105Routes } from '@ng-bundler-benchmark/lib1105';
...
export const lib105Routes: Route[] = [
    { path: 'lib1105', children: lib1105Routes },
  { path: '', component: Lib105Component },

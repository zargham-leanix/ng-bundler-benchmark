...
import { Lib141Component } from './lib141/lib141.component';
import { lib1141Routes } from '@ng-bundler-benchmark/lib1141';
...
export const lib141Routes: Route[] = [
    { path: 'lib1141', children: lib1141Routes },
  { path: '', component: Lib141Component },

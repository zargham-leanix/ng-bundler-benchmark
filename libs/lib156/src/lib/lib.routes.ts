...
import { Lib156Component } from './lib156/lib156.component';
import { lib1156Routes } from '@ng-bundler-benchmark/lib1156';
...
export const lib156Routes: Route[] = [
    { path: 'lib1156', children: lib1156Routes },
  { path: '', component: Lib156Component },

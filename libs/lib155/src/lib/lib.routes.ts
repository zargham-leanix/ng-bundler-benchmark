...
import { Lib155Component } from './lib155/lib155.component';
import { lib1155Routes } from '@ng-bundler-benchmark/lib1155';
...
export const lib155Routes: Route[] = [
    { path: 'lib1155', children: lib1155Routes },
  { path: '', component: Lib155Component },

...
import { Lib357Component } from './lib357/lib357.component';
import { lib1357Routes } from '@ng-bundler-benchmark/lib1357';
...
export const lib357Routes: Route[] = [
    { path: 'lib1357', children: lib1357Routes },
  { path: '', component: Lib357Component },

...
import { Lib324Component } from './lib324/lib324.component';
import { lib1324Routes } from '@ng-bundler-benchmark/lib1324';
...
export const lib324Routes: Route[] = [
    { path: 'lib1324', children: lib1324Routes },
  { path: '', component: Lib324Component },

...
import { Lib386Component } from './lib386/lib386.component';
import { lib1386Routes } from '@ng-bundler-benchmark/lib1386';
...
export const lib386Routes: Route[] = [
    { path: 'lib1386', children: lib1386Routes },
  { path: '', component: Lib386Component },

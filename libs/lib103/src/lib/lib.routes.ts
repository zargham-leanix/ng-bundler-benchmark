...
import { Lib103Component } from './lib103/lib103.component';
import { lib1103Routes } from '@ng-bundler-benchmark/lib1103';
...
export const lib103Routes: Route[] = [
    { path: 'lib1103', children: lib1103Routes },
  { path: '', component: Lib103Component },

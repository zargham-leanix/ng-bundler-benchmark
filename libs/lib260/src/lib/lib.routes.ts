...
import { Lib260Component } from './lib260/lib260.component';
import { lib1260Routes } from '@ng-bundler-benchmark/lib1260';
...
export const lib260Routes: Route[] = [
    { path: 'lib1260', children: lib1260Routes },
  { path: '', component: Lib260Component },

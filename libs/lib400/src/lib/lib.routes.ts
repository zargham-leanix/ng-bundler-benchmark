...
import { Lib400Component } from './lib400/lib400.component';
import { lib1400Routes } from '@ng-bundler-benchmark/lib1400';
...
export const lib400Routes: Route[] = [
    { path: 'lib1400', children: lib1400Routes },
  { path: '', component: Lib400Component },

...
import { Lib195Component } from './lib195/lib195.component';
import { lib1195Routes } from '@ng-bundler-benchmark/lib1195';
...
export const lib195Routes: Route[] = [
    { path: 'lib1195', children: lib1195Routes },
  { path: '', component: Lib195Component },

...
import { Lib191Component } from './lib191/lib191.component';
import { lib1191Routes } from '@ng-bundler-benchmark/lib1191';
...
export const lib191Routes: Route[] = [
    { path: 'lib1191', children: lib1191Routes },
  { path: '', component: Lib191Component },

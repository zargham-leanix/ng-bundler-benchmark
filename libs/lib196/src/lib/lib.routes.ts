...
import { Lib196Component } from './lib196/lib196.component';
import { lib1196Routes } from '@ng-bundler-benchmark/lib1196';
...
export const lib196Routes: Route[] = [
    { path: 'lib1196', children: lib1196Routes },
  { path: '', component: Lib196Component },

...
import { Lib177Component } from './lib177/lib177.component';
import { lib1177Routes } from '@ng-bundler-benchmark/lib1177';
...
export const lib177Routes: Route[] = [
    { path: 'lib1177', children: lib1177Routes },
  { path: '', component: Lib177Component },

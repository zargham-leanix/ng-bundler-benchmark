...
import { Lib153Component } from './lib153/lib153.component';
import { lib1153Routes } from '@ng-bundler-benchmark/lib1153';
...
export const lib153Routes: Route[] = [
    { path: 'lib1153', children: lib1153Routes },
  { path: '', component: Lib153Component },

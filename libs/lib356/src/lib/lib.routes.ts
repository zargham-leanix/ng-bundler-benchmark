...
import { Lib356Component } from './lib356/lib356.component';
import { lib1356Routes } from '@ng-bundler-benchmark/lib1356';
...
export const lib356Routes: Route[] = [
    { path: 'lib1356', children: lib1356Routes },
  { path: '', component: Lib356Component },

...
import { Lib307Component } from './lib307/lib307.component';
import { lib1307Routes } from '@ng-bundler-benchmark/lib1307';
...
export const lib307Routes: Route[] = [
    { path: 'lib1307', children: lib1307Routes },
  { path: '', component: Lib307Component },

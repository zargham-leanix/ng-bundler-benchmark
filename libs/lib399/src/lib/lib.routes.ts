...
import { Lib399Component } from './lib399/lib399.component';
import { lib1399Routes } from '@ng-bundler-benchmark/lib1399';
...
export const lib399Routes: Route[] = [
    { path: 'lib1399', children: lib1399Routes },
  { path: '', component: Lib399Component },

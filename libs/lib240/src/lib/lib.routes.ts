...
import { Lib240Component } from './lib240/lib240.component';
import { lib1240Routes } from '@ng-bundler-benchmark/lib1240';
...
export const lib240Routes: Route[] = [
    { path: 'lib1240', children: lib1240Routes },
  { path: '', component: Lib240Component },

...
import { Lib355Component } from './lib355/lib355.component';
import { lib1355Routes } from '@ng-bundler-benchmark/lib1355';
...
export const lib355Routes: Route[] = [
    { path: 'lib1355', children: lib1355Routes },
  { path: '', component: Lib355Component },

...
import { Lib157Component } from './lib157/lib157.component';
import { lib1157Routes } from '@ng-bundler-benchmark/lib1157';
...
export const lib157Routes: Route[] = [
    { path: 'lib1157', children: lib1157Routes },
  { path: '', component: Lib157Component },

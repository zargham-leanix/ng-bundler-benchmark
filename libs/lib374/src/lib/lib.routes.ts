...
import { Lib374Component } from './lib374/lib374.component';
import { lib1374Routes } from '@ng-bundler-benchmark/lib1374';
...
export const lib374Routes: Route[] = [
    { path: 'lib1374', children: lib1374Routes },
  { path: '', component: Lib374Component },

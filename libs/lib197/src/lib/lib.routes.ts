...
import { Lib197Component } from './lib197/lib197.component';
import { lib1197Routes } from '@ng-bundler-benchmark/lib1197';
...
export const lib197Routes: Route[] = [
    { path: 'lib1197', children: lib1197Routes },
  { path: '', component: Lib197Component },

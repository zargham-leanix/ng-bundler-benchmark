...
import { Lib313Component } from './lib313/lib313.component';
import { lib1313Routes } from '@ng-bundler-benchmark/lib1313';
...
export const lib313Routes: Route[] = [
    { path: 'lib1313', children: lib1313Routes },
  { path: '', component: Lib313Component },

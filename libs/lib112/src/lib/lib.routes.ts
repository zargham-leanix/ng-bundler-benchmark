...
import { Lib112Component } from './lib112/lib112.component';
import { lib1112Routes } from '@ng-bundler-benchmark/lib1112';
...
export const lib112Routes: Route[] = [
    { path: 'lib1112', children: lib1112Routes },
  { path: '', component: Lib112Component },

...
import { Lib244Component } from './lib244/lib244.component';
import { lib1244Routes } from '@ng-bundler-benchmark/lib1244';
...
export const lib244Routes: Route[] = [
    { path: 'lib1244', children: lib1244Routes },
  { path: '', component: Lib244Component },

...
import { Lib169Component } from './lib169/lib169.component';
import { lib1169Routes } from '@ng-bundler-benchmark/lib1169';
...
export const lib169Routes: Route[] = [
    { path: 'lib1169', children: lib1169Routes },
  { path: '', component: Lib169Component },

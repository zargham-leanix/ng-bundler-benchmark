...
import { Lib391Component } from './lib391/lib391.component';
import { lib1391Routes } from '@ng-bundler-benchmark/lib1391';
...
export const lib391Routes: Route[] = [
    { path: 'lib1391', children: lib1391Routes },
  { path: '', component: Lib391Component },

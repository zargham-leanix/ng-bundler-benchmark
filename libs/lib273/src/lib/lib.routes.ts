...
import { Lib273Component } from './lib273/lib273.component';
import { lib1273Routes } from '@ng-bundler-benchmark/lib1273';
...
export const lib273Routes: Route[] = [
    { path: 'lib1273', children: lib1273Routes },
  { path: '', component: Lib273Component },

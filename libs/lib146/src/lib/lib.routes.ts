...
import { Lib146Component } from './lib146/lib146.component';
import { lib1146Routes } from '@ng-bundler-benchmark/lib1146';
...
export const lib146Routes: Route[] = [
    { path: 'lib1146', children: lib1146Routes },
  { path: '', component: Lib146Component },

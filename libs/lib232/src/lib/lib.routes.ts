...
import { Lib232Component } from './lib232/lib232.component';
import { lib1232Routes } from '@ng-bundler-benchmark/lib1232';
...
export const lib232Routes: Route[] = [
    { path: 'lib1232', children: lib1232Routes },
  { path: '', component: Lib232Component },

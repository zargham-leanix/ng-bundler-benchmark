...
import { Lib206Component } from './lib206/lib206.component';
import { lib1206Routes } from '@ng-bundler-benchmark/lib1206';
...
export const lib206Routes: Route[] = [
    { path: 'lib1206', children: lib1206Routes },
  { path: '', component: Lib206Component },

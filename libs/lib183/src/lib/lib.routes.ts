...
import { Lib183Component } from './lib183/lib183.component';
import { lib1183Routes } from '@ng-bundler-benchmark/lib1183';
...
export const lib183Routes: Route[] = [
    { path: 'lib1183', children: lib1183Routes },
  { path: '', component: Lib183Component },

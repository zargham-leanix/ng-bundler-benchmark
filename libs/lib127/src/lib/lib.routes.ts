...
import { Lib127Component } from './lib127/lib127.component';
import { lib1127Routes } from '@ng-bundler-benchmark/lib1127';
...
export const lib127Routes: Route[] = [
    { path: 'lib1127', children: lib1127Routes },
  { path: '', component: Lib127Component },

...
import { Lib329Component } from './lib329/lib329.component';
import { lib1329Routes } from '@ng-bundler-benchmark/lib1329';
...
export const lib329Routes: Route[] = [
    { path: 'lib1329', children: lib1329Routes },
  { path: '', component: Lib329Component },

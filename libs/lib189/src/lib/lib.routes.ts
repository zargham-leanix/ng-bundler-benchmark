...
import { Lib189Component } from './lib189/lib189.component';
import { lib1189Routes } from '@ng-bundler-benchmark/lib1189';
...
export const lib189Routes: Route[] = [
    { path: 'lib1189', children: lib1189Routes },
  { path: '', component: Lib189Component },

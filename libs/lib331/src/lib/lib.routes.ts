...
import { Lib331Component } from './lib331/lib331.component';
import { lib1331Routes } from '@ng-bundler-benchmark/lib1331';
...
export const lib331Routes: Route[] = [
    { path: 'lib1331', children: lib1331Routes },
  { path: '', component: Lib331Component },

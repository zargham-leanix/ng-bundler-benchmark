...
import { Lib259Component } from './lib259/lib259.component';
import { lib1259Routes } from '@ng-bundler-benchmark/lib1259';
...
export const lib259Routes: Route[] = [
    { path: 'lib1259', children: lib1259Routes },
  { path: '', component: Lib259Component },

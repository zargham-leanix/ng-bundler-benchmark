...
import { Lib113Component } from './lib113/lib113.component';
import { lib1113Routes } from '@ng-bundler-benchmark/lib1113';
...
export const lib113Routes: Route[] = [
    { path: 'lib1113', children: lib1113Routes },
  { path: '', component: Lib113Component },

...
import { Lib304Component } from './lib304/lib304.component';
import { lib1304Routes } from '@ng-bundler-benchmark/lib1304';
...
export const lib304Routes: Route[] = [
    { path: 'lib1304', children: lib1304Routes },
  { path: '', component: Lib304Component },

...
import { Lib335Component } from './lib335/lib335.component';
import { lib1335Routes } from '@ng-bundler-benchmark/lib1335';
...
export const lib335Routes: Route[] = [
    { path: 'lib1335', children: lib1335Routes },
  { path: '', component: Lib335Component },

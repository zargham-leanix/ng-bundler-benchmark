...
import { Lib204Component } from './lib204/lib204.component';
import { lib1204Routes } from '@ng-bundler-benchmark/lib1204';
...
export const lib204Routes: Route[] = [
    { path: 'lib1204', children: lib1204Routes },
  { path: '', component: Lib204Component },

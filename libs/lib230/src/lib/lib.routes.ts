...
import { Lib230Component } from './lib230/lib230.component';
import { lib1230Routes } from '@ng-bundler-benchmark/lib1230';
...
export const lib230Routes: Route[] = [
    { path: 'lib1230', children: lib1230Routes },
  { path: '', component: Lib230Component },

...
import { Lib99Component } from './lib99/lib99.component';
import { lib1099Routes } from '@ng-bundler-benchmark/lib1099';
...
export const lib99Routes: Route[] = [
    { path: 'lib1099', children: lib1099Routes },
  { path: '', component: Lib99Component },

...
import { Lib360Component } from './lib360/lib360.component';
import { lib1360Routes } from '@ng-bundler-benchmark/lib1360';
...
export const lib360Routes: Route[] = [
    { path: 'lib1360', children: lib1360Routes },
  { path: '', component: Lib360Component },

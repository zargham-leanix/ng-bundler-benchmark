...
import { Lib290Component } from './lib290/lib290.component';
import { lib1290Routes } from '@ng-bundler-benchmark/lib1290';
...
export const lib290Routes: Route[] = [
    { path: 'lib1290', children: lib1290Routes },
  { path: '', component: Lib290Component },

...
import { Lib314Component } from './lib314/lib314.component';
import { lib1314Routes } from '@ng-bundler-benchmark/lib1314';
...
export const lib314Routes: Route[] = [
    { path: 'lib1314', children: lib1314Routes },
  { path: '', component: Lib314Component },

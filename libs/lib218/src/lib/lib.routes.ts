...
import { Lib218Component } from './lib218/lib218.component';
import { lib1218Routes } from '@ng-bundler-benchmark/lib1218';
...
export const lib218Routes: Route[] = [
    { path: 'lib1218', children: lib1218Routes },
  { path: '', component: Lib218Component },

...
import { Lib134Component } from './lib134/lib134.component';
import { lib1134Routes } from '@ng-bundler-benchmark/lib1134';
...
export const lib134Routes: Route[] = [
    { path: 'lib1134', children: lib1134Routes },
  { path: '', component: Lib134Component },

...
import { Lib388Component } from './lib388/lib388.component';
import { lib1388Routes } from '@ng-bundler-benchmark/lib1388';
...
export const lib388Routes: Route[] = [
    { path: 'lib1388', children: lib1388Routes },
  { path: '', component: Lib388Component },

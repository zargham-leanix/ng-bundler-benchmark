...
import { Lib95Component } from './lib95/lib95.component';
import { lib1095Routes } from '@ng-bundler-benchmark/lib1095';
...
export const lib95Routes: Route[] = [
    { path: 'lib1095', children: lib1095Routes },
  { path: '', component: Lib95Component },

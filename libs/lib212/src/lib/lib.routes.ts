...
import { Lib212Component } from './lib212/lib212.component';
import { lib1212Routes } from '@ng-bundler-benchmark/lib1212';
...
export const lib212Routes: Route[] = [
    { path: 'lib1212', children: lib1212Routes },
  { path: '', component: Lib212Component },

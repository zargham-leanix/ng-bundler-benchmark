...
import { Lib239Component } from './lib239/lib239.component';
import { lib1239Routes } from '@ng-bundler-benchmark/lib1239';
...
export const lib239Routes: Route[] = [
    { path: 'lib1239', children: lib1239Routes },
  { path: '', component: Lib239Component },

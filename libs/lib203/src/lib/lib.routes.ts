...
import { Lib203Component } from './lib203/lib203.component';
import { lib1203Routes } from '@ng-bundler-benchmark/lib1203';
...
export const lib203Routes: Route[] = [
    { path: 'lib1203', children: lib1203Routes },
  { path: '', component: Lib203Component },

...
import { Lib215Component } from './lib215/lib215.component';
import { lib1215Routes } from '@ng-bundler-benchmark/lib1215';
...
export const lib215Routes: Route[] = [
    { path: 'lib1215', children: lib1215Routes },
  { path: '', component: Lib215Component },

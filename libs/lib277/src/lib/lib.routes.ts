...
import { Lib277Component } from './lib277/lib277.component';
import { lib1277Routes } from '@ng-bundler-benchmark/lib1277';
...
export const lib277Routes: Route[] = [
    { path: 'lib1277', children: lib1277Routes },
  { path: '', component: Lib277Component },

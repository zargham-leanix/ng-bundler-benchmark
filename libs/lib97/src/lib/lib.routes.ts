...
import { Lib97Component } from './lib97/lib97.component';
import { lib1097Routes } from '@ng-bundler-benchmark/lib1097';
...
export const lib97Routes: Route[] = [
    { path: 'lib1097', children: lib1097Routes },
  { path: '', component: Lib97Component },

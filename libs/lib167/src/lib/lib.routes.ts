...
import { Lib167Component } from './lib167/lib167.component';
import { lib1167Routes } from '@ng-bundler-benchmark/lib1167';
...
export const lib167Routes: Route[] = [
    { path: 'lib1167', children: lib1167Routes },
  { path: '', component: Lib167Component },

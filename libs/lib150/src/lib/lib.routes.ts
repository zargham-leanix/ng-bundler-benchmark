...
import { Lib150Component } from './lib150/lib150.component';
import { lib1150Routes } from '@ng-bundler-benchmark/lib1150';
...
export const lib150Routes: Route[] = [
    { path: 'lib1150', children: lib1150Routes },
  { path: '', component: Lib150Component },

...
import { Lib178Component } from './lib178/lib178.component';
import { lib1178Routes } from '@ng-bundler-benchmark/lib1178';
...
export const lib178Routes: Route[] = [
    { path: 'lib1178', children: lib1178Routes },
  { path: '', component: Lib178Component },

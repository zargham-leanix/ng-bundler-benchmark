...
import { Lib266Component } from './lib266/lib266.component';
import { lib1266Routes } from '@ng-bundler-benchmark/lib1266';
...
export const lib266Routes: Route[] = [
    { path: 'lib1266', children: lib1266Routes },
  { path: '', component: Lib266Component },

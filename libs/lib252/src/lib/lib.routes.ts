...
import { Lib252Component } from './lib252/lib252.component';
import { lib1252Routes } from '@ng-bundler-benchmark/lib1252';
...
export const lib252Routes: Route[] = [
    { path: 'lib1252', children: lib1252Routes },
  { path: '', component: Lib252Component },

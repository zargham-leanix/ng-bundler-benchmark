...
import { Lib258Component } from './lib258/lib258.component';
import { lib1258Routes } from '@ng-bundler-benchmark/lib1258';
...
export const lib258Routes: Route[] = [
    { path: 'lib1258', children: lib1258Routes },
  { path: '', component: Lib258Component },

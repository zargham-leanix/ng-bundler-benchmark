...
import { Lib347Component } from './lib347/lib347.component';
import { lib1347Routes } from '@ng-bundler-benchmark/lib1347';
...
export const lib347Routes: Route[] = [
    { path: 'lib1347', children: lib1347Routes },
  { path: '', component: Lib347Component },

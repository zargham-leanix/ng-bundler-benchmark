...
import { Lib165Component } from './lib165/lib165.component';
import { lib1165Routes } from '@ng-bundler-benchmark/lib1165';
...
export const lib165Routes: Route[] = [
    { path: 'lib1165', children: lib1165Routes },
  { path: '', component: Lib165Component },

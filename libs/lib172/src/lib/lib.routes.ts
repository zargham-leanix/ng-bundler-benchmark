...
import { Lib172Component } from './lib172/lib172.component';
import { lib1172Routes } from '@ng-bundler-benchmark/lib1172';
...
export const lib172Routes: Route[] = [
    { path: 'lib1172', children: lib1172Routes },
  { path: '', component: Lib172Component },

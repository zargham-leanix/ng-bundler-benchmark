...
import { Lib272Component } from './lib272/lib272.component';
import { lib1272Routes } from '@ng-bundler-benchmark/lib1272';
...
export const lib272Routes: Route[] = [
    { path: 'lib1272', children: lib1272Routes },
  { path: '', component: Lib272Component },

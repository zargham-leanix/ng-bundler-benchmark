...
import { Lib180Component } from './lib180/lib180.component';
import { lib1180Routes } from '@ng-bundler-benchmark/lib1180';
...
export const lib180Routes: Route[] = [
    { path: 'lib1180', children: lib1180Routes },
  { path: '', component: Lib180Component },

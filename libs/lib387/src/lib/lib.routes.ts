...
import { Lib387Component } from './lib387/lib387.component';
import { lib1387Routes } from '@ng-bundler-benchmark/lib1387';
...
export const lib387Routes: Route[] = [
    { path: 'lib1387', children: lib1387Routes },
  { path: '', component: Lib387Component },

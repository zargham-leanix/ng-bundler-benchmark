...
import { Lib168Component } from './lib168/lib168.component';
import { lib1168Routes } from '@ng-bundler-benchmark/lib1168';
...
export const lib168Routes: Route[] = [
    { path: 'lib1168', children: lib1168Routes },
  { path: '', component: Lib168Component },

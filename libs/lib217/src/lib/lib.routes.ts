...
import { Lib217Component } from './lib217/lib217.component';
import { lib1217Routes } from '@ng-bundler-benchmark/lib1217';
...
export const lib217Routes: Route[] = [
    { path: 'lib1217', children: lib1217Routes },
  { path: '', component: Lib217Component },

...
import { Lib171Component } from './lib171/lib171.component';
import { lib1171Routes } from '@ng-bundler-benchmark/lib1171';
...
export const lib171Routes: Route[] = [
    { path: 'lib1171', children: lib1171Routes },
  { path: '', component: Lib171Component },

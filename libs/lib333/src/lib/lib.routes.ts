...
import { Lib333Component } from './lib333/lib333.component';
import { lib1333Routes } from '@ng-bundler-benchmark/lib1333';
...
export const lib333Routes: Route[] = [
    { path: 'lib1333', children: lib1333Routes },
  { path: '', component: Lib333Component },

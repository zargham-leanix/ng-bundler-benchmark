...
import { Lib179Component } from './lib179/lib179.component';
import { lib1179Routes } from '@ng-bundler-benchmark/lib1179';
...
export const lib179Routes: Route[] = [
    { path: 'lib1179', children: lib1179Routes },
  { path: '', component: Lib179Component },

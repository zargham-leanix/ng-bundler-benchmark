...
import { Lib133Component } from './lib133/lib133.component';
import { lib1133Routes } from '@ng-bundler-benchmark/lib1133';
...
export const lib133Routes: Route[] = [
    { path: 'lib1133', children: lib1133Routes },
  { path: '', component: Lib133Component },

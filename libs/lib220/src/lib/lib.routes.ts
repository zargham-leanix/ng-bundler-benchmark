...
import { Lib220Component } from './lib220/lib220.component';
import { lib1220Routes } from '@ng-bundler-benchmark/lib1220';
...
export const lib220Routes: Route[] = [
    { path: 'lib1220', children: lib1220Routes },
  { path: '', component: Lib220Component },

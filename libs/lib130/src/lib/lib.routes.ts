...
import { Lib130Component } from './lib130/lib130.component';
import { lib1130Routes } from '@ng-bundler-benchmark/lib1130';
...
export const lib130Routes: Route[] = [
    { path: 'lib1130', children: lib1130Routes },
  { path: '', component: Lib130Component },

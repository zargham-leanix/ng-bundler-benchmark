...
import { Lib114Component } from './lib114/lib114.component';
import { lib1114Routes } from '@ng-bundler-benchmark/lib1114';
...
export const lib114Routes: Route[] = [
    { path: 'lib1114', children: lib1114Routes },
  { path: '', component: Lib114Component },

...
import { Lib192Component } from './lib192/lib192.component';
import { lib1192Routes } from '@ng-bundler-benchmark/lib1192';
...
export const lib192Routes: Route[] = [
    { path: 'lib1192', children: lib1192Routes },
  { path: '', component: Lib192Component },

...
import { Lib187Component } from './lib187/lib187.component';
import { lib1187Routes } from '@ng-bundler-benchmark/lib1187';
...
export const lib187Routes: Route[] = [
    { path: 'lib1187', children: lib1187Routes },
  { path: '', component: Lib187Component },

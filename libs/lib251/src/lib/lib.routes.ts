...
import { Lib251Component } from './lib251/lib251.component';
import { lib1251Routes } from '@ng-bundler-benchmark/lib1251';
...
export const lib251Routes: Route[] = [
    { path: 'lib1251', children: lib1251Routes },
  { path: '', component: Lib251Component },

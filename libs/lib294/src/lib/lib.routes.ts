...
import { Lib294Component } from './lib294/lib294.component';
import { lib1294Routes } from '@ng-bundler-benchmark/lib1294';
...
export const lib294Routes: Route[] = [
    { path: 'lib1294', children: lib1294Routes },
  { path: '', component: Lib294Component },

...
import { Lib321Component } from './lib321/lib321.component';
import { lib1321Routes } from '@ng-bundler-benchmark/lib1321';
...
export const lib321Routes: Route[] = [
    { path: 'lib1321', children: lib1321Routes },
  { path: '', component: Lib321Component },

...
import { Lib382Component } from './lib382/lib382.component';
import { lib1382Routes } from '@ng-bundler-benchmark/lib1382';
...
export const lib382Routes: Route[] = [
    { path: 'lib1382', children: lib1382Routes },
  { path: '', component: Lib382Component },

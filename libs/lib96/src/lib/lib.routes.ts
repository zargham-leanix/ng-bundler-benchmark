...
import { Lib96Component } from './lib96/lib96.component';
import { lib1096Routes } from '@ng-bundler-benchmark/lib1096';
...
export const lib96Routes: Route[] = [
    { path: 'lib1096', children: lib1096Routes },
  { path: '', component: Lib96Component },

...
import { Lib256Component } from './lib256/lib256.component';
import { lib1256Routes } from '@ng-bundler-benchmark/lib1256';
...
export const lib256Routes: Route[] = [
    { path: 'lib1256', children: lib1256Routes },
  { path: '', component: Lib256Component },

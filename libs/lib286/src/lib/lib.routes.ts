...
import { Lib286Component } from './lib286/lib286.component';
import { lib1286Routes } from '@ng-bundler-benchmark/lib1286';
...
export const lib286Routes: Route[] = [
    { path: 'lib1286', children: lib1286Routes },
  { path: '', component: Lib286Component },

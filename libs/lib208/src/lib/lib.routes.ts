...
import { Lib208Component } from './lib208/lib208.component';
import { lib1208Routes } from '@ng-bundler-benchmark/lib1208';
...
export const lib208Routes: Route[] = [
    { path: 'lib1208', children: lib1208Routes },
  { path: '', component: Lib208Component },

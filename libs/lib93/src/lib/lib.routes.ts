...
import { Lib93Component } from './lib93/lib93.component';
import { lib1093Routes } from '@ng-bundler-benchmark/lib1093';
...
export const lib93Routes: Route[] = [
    { path: 'lib1093', children: lib1093Routes },
  { path: '', component: Lib93Component },

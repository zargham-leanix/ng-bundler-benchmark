...
import { Lib306Component } from './lib306/lib306.component';
import { lib1306Routes } from '@ng-bundler-benchmark/lib1306';
...
export const lib306Routes: Route[] = [
    { path: 'lib1306', children: lib1306Routes },
  { path: '', component: Lib306Component },

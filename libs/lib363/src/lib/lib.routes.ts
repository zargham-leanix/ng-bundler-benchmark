...
import { Lib363Component } from './lib363/lib363.component';
import { lib1363Routes } from '@ng-bundler-benchmark/lib1363';
...
export const lib363Routes: Route[] = [
    { path: 'lib1363', children: lib1363Routes },
  { path: '', component: Lib363Component },

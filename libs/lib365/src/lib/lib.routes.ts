...
import { Lib365Component } from './lib365/lib365.component';
import { lib1365Routes } from '@ng-bundler-benchmark/lib1365';
...
export const lib365Routes: Route[] = [
    { path: 'lib1365', children: lib1365Routes },
  { path: '', component: Lib365Component },

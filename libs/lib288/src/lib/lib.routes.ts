...
import { Lib288Component } from './lib288/lib288.component';
import { lib1288Routes } from '@ng-bundler-benchmark/lib1288';
...
export const lib288Routes: Route[] = [
    { path: 'lib1288', children: lib1288Routes },
  { path: '', component: Lib288Component },

...
import { Lib106Component } from './lib106/lib106.component';
import { lib1106Routes } from '@ng-bundler-benchmark/lib1106';
...
export const lib106Routes: Route[] = [
    { path: 'lib1106', children: lib1106Routes },
  { path: '', component: Lib106Component },

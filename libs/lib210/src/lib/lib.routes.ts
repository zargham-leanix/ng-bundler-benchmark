...
import { Lib210Component } from './lib210/lib210.component';
import { lib1210Routes } from '@ng-bundler-benchmark/lib1210';
...
export const lib210Routes: Route[] = [
    { path: 'lib1210', children: lib1210Routes },
  { path: '', component: Lib210Component },

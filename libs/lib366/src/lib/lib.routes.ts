...
import { Lib366Component } from './lib366/lib366.component';
import { lib1366Routes } from '@ng-bundler-benchmark/lib1366';
...
export const lib366Routes: Route[] = [
    { path: 'lib1366', children: lib1366Routes },
  { path: '', component: Lib366Component },

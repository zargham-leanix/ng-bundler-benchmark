...
import { Lib243Component } from './lib243/lib243.component';
import { lib1243Routes } from '@ng-bundler-benchmark/lib1243';
...
export const lib243Routes: Route[] = [
    { path: 'lib1243', children: lib1243Routes },
  { path: '', component: Lib243Component },

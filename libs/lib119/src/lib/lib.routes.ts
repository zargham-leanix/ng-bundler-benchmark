...
import { Lib119Component } from './lib119/lib119.component';
import { lib1119Routes } from '@ng-bundler-benchmark/lib1119';
...
export const lib119Routes: Route[] = [
    { path: 'lib1119', children: lib1119Routes },
  { path: '', component: Lib119Component },

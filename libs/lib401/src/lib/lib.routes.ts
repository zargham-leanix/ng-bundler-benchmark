...
import { Lib401Component } from './lib401/lib401.component';
import { lib1401Routes } from '@ng-bundler-benchmark/lib1401';
...
export const lib401Routes: Route[] = [
    { path: 'lib1401', children: lib1401Routes },
  { path: '', component: Lib401Component },

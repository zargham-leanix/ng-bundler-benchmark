...
import { Lib121Component } from './lib121/lib121.component';
import { lib1121Routes } from '@ng-bundler-benchmark/lib1121';
...
export const lib121Routes: Route[] = [
    { path: 'lib1121', children: lib1121Routes },
  { path: '', component: Lib121Component },

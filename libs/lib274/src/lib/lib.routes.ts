...
import { Lib274Component } from './lib274/lib274.component';
import { lib1274Routes } from '@ng-bundler-benchmark/lib1274';
...
export const lib274Routes: Route[] = [
    { path: 'lib1274', children: lib1274Routes },
  { path: '', component: Lib274Component },

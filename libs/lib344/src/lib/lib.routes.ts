...
import { Lib344Component } from './lib344/lib344.component';
import { lib1344Routes } from '@ng-bundler-benchmark/lib1344';
...
export const lib344Routes: Route[] = [
    { path: 'lib1344', children: lib1344Routes },
  { path: '', component: Lib344Component },

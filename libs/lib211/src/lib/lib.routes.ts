...
import { Lib211Component } from './lib211/lib211.component';
import { lib1211Routes } from '@ng-bundler-benchmark/lib1211';
...
export const lib211Routes: Route[] = [
    { path: 'lib1211', children: lib1211Routes },
  { path: '', component: Lib211Component },

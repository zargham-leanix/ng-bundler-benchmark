...
import { Lib265Component } from './lib265/lib265.component';
import { lib1265Routes } from '@ng-bundler-benchmark/lib1265';
...
export const lib265Routes: Route[] = [
    { path: 'lib1265', children: lib1265Routes },
  { path: '', component: Lib265Component },

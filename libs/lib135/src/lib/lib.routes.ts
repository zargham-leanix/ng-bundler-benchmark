...
import { Lib135Component } from './lib135/lib135.component';
import { lib1135Routes } from '@ng-bundler-benchmark/lib1135';
...
export const lib135Routes: Route[] = [
    { path: 'lib1135', children: lib1135Routes },
  { path: '', component: Lib135Component },

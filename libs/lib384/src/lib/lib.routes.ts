...
import { Lib384Component } from './lib384/lib384.component';
import { lib1384Routes } from '@ng-bundler-benchmark/lib1384';
...
export const lib384Routes: Route[] = [
    { path: 'lib1384', children: lib1384Routes },
  { path: '', component: Lib384Component },

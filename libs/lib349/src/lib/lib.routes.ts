...
import { Lib349Component } from './lib349/lib349.component';
import { lib1349Routes } from '@ng-bundler-benchmark/lib1349';
...
export const lib349Routes: Route[] = [
    { path: 'lib1349', children: lib1349Routes },
  { path: '', component: Lib349Component },

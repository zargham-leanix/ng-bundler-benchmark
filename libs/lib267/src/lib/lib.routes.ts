...
import { Lib267Component } from './lib267/lib267.component';
import { lib1267Routes } from '@ng-bundler-benchmark/lib1267';
...
export const lib267Routes: Route[] = [
    { path: 'lib1267', children: lib1267Routes },
  { path: '', component: Lib267Component },

...
import { Lib338Component } from './lib338/lib338.component';
import { lib1338Routes } from '@ng-bundler-benchmark/lib1338';
...
export const lib338Routes: Route[] = [
    { path: 'lib1338', children: lib1338Routes },
  { path: '', component: Lib338Component },

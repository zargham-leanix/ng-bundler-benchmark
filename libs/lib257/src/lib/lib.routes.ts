...
import { Lib257Component } from './lib257/lib257.component';
import { lib1257Routes } from '@ng-bundler-benchmark/lib1257';
...
export const lib257Routes: Route[] = [
    { path: 'lib1257', children: lib1257Routes },
  { path: '', component: Lib257Component },

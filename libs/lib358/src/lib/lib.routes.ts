...
import { Lib358Component } from './lib358/lib358.component';
import { lib1358Routes } from '@ng-bundler-benchmark/lib1358';
...
export const lib358Routes: Route[] = [
    { path: 'lib1358', children: lib1358Routes },
  { path: '', component: Lib358Component },

...
import { Lib398Component } from './lib398/lib398.component';
import { lib1398Routes } from '@ng-bundler-benchmark/lib1398';
...
export const lib398Routes: Route[] = [
    { path: 'lib1398', children: lib1398Routes },
  { path: '', component: Lib398Component },

...
import { Lib137Component } from './lib137/lib137.component';
import { lib1137Routes } from '@ng-bundler-benchmark/lib1137';
...
export const lib137Routes: Route[] = [
    { path: 'lib1137', children: lib1137Routes },
  { path: '', component: Lib137Component },

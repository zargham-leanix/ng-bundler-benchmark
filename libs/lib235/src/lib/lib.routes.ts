...
import { Lib235Component } from './lib235/lib235.component';
import { lib1235Routes } from '@ng-bundler-benchmark/lib1235';
...
export const lib235Routes: Route[] = [
    { path: 'lib1235', children: lib1235Routes },
  { path: '', component: Lib235Component },

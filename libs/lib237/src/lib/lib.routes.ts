...
import { Lib237Component } from './lib237/lib237.component';
import { lib1237Routes } from '@ng-bundler-benchmark/lib1237';
...
export const lib237Routes: Route[] = [
    { path: 'lib1237', children: lib1237Routes },
  { path: '', component: Lib237Component },

...
import { Lib224Component } from './lib224/lib224.component';
import { lib1224Routes } from '@ng-bundler-benchmark/lib1224';
...
export const lib224Routes: Route[] = [
    { path: 'lib1224', children: lib1224Routes },
  { path: '', component: Lib224Component },

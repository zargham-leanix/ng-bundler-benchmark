...
import { Lib293Component } from './lib293/lib293.component';
import { lib1293Routes } from '@ng-bundler-benchmark/lib1293';
...
export const lib293Routes: Route[] = [
    { path: 'lib1293', children: lib1293Routes },
  { path: '', component: Lib293Component },

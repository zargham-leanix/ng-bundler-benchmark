...
import { Lib205Component } from './lib205/lib205.component';
import { lib1205Routes } from '@ng-bundler-benchmark/lib1205';
...
export const lib205Routes: Route[] = [
    { path: 'lib1205', children: lib1205Routes },
  { path: '', component: Lib205Component },

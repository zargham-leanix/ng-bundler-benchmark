...
import { Lib285Component } from './lib285/lib285.component';
import { lib1285Routes } from '@ng-bundler-benchmark/lib1285';
...
export const lib285Routes: Route[] = [
    { path: 'lib1285', children: lib1285Routes },
  { path: '', component: Lib285Component },

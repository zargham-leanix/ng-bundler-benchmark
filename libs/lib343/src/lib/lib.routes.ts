...
import { Lib343Component } from './lib343/lib343.component';
import { lib1343Routes } from '@ng-bundler-benchmark/lib1343';
...
export const lib343Routes: Route[] = [
    { path: 'lib1343', children: lib1343Routes },
  { path: '', component: Lib343Component },

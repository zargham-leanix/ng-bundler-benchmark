...
import { Lib102Component } from './lib102/lib102.component';
import { lib1102Routes } from '@ng-bundler-benchmark/lib1102';
...
export const lib102Routes: Route[] = [
    { path: 'lib1102', children: lib1102Routes },
  { path: '', component: Lib102Component },

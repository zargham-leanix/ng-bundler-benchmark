...
import { Lib378Component } from './lib378/lib378.component';
import { lib1378Routes } from '@ng-bundler-benchmark/lib1378';
...
export const lib378Routes: Route[] = [
    { path: 'lib1378', children: lib1378Routes },
  { path: '', component: Lib378Component },

...
import { Lib275Component } from './lib275/lib275.component';
import { lib1275Routes } from '@ng-bundler-benchmark/lib1275';
...
export const lib275Routes: Route[] = [
    { path: 'lib1275', children: lib1275Routes },
  { path: '', component: Lib275Component },

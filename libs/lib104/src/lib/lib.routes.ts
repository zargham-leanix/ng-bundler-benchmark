...
import { Lib104Component } from './lib104/lib104.component';
import { lib1104Routes } from '@ng-bundler-benchmark/lib1104';
...
export const lib104Routes: Route[] = [
    { path: 'lib1104', children: lib1104Routes },
  { path: '', component: Lib104Component },

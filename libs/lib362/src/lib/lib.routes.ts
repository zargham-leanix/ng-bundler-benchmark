...
import { Lib362Component } from './lib362/lib362.component';
import { lib1362Routes } from '@ng-bundler-benchmark/lib1362';
...
export const lib362Routes: Route[] = [
    { path: 'lib1362', children: lib1362Routes },
  { path: '', component: Lib362Component },

...
import { Lib228Component } from './lib228/lib228.component';
import { lib1228Routes } from '@ng-bundler-benchmark/lib1228';
...
export const lib228Routes: Route[] = [
    { path: 'lib1228', children: lib1228Routes },
  { path: '', component: Lib228Component },

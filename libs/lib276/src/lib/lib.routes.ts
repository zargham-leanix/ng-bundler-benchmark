...
import { Lib276Component } from './lib276/lib276.component';
import { lib1276Routes } from '@ng-bundler-benchmark/lib1276';
...
export const lib276Routes: Route[] = [
    { path: 'lib1276', children: lib1276Routes },
  { path: '', component: Lib276Component },

...
import { Lib92Component } from './lib92/lib92.component';
import { lib1092Routes } from '@ng-bundler-benchmark/lib1092';
...
export const lib92Routes: Route[] = [
    { path: 'lib1092', children: lib1092Routes },
  { path: '', component: Lib92Component },

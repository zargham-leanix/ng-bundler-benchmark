...
import { Lib280Component } from './lib280/lib280.component';
import { lib1280Routes } from '@ng-bundler-benchmark/lib1280';
...
export const lib280Routes: Route[] = [
    { path: 'lib1280', children: lib1280Routes },
  { path: '', component: Lib280Component },

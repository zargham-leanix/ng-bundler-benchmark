...
import { Lib379Component } from './lib379/lib379.component';
import { lib1379Routes } from '@ng-bundler-benchmark/lib1379';
...
export const lib379Routes: Route[] = [
    { path: 'lib1379', children: lib1379Routes },
  { path: '', component: Lib379Component },

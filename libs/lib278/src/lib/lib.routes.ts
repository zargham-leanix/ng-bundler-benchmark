...
import { Lib278Component } from './lib278/lib278.component';
import { lib1278Routes } from '@ng-bundler-benchmark/lib1278';
...
export const lib278Routes: Route[] = [
    { path: 'lib1278', children: lib1278Routes },
  { path: '', component: Lib278Component },

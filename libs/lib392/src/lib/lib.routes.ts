...
import { Lib392Component } from './lib392/lib392.component';
import { lib1392Routes } from '@ng-bundler-benchmark/lib1392';
...
export const lib392Routes: Route[] = [
    { path: 'lib1392', children: lib1392Routes },
  { path: '', component: Lib392Component },

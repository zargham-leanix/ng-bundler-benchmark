...
import { Lib181Component } from './lib181/lib181.component';
import { lib1181Routes } from '@ng-bundler-benchmark/lib1181';
...
export const lib181Routes: Route[] = [
    { path: 'lib1181', children: lib1181Routes },
  { path: '', component: Lib181Component },

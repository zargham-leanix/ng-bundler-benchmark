...
import { Lib351Component } from './lib351/lib351.component';
import { lib1351Routes } from '@ng-bundler-benchmark/lib1351';
...
export const lib351Routes: Route[] = [
    { path: 'lib1351', children: lib1351Routes },
  { path: '', component: Lib351Component },

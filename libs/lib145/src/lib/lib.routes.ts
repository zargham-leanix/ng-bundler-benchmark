...
import { Lib145Component } from './lib145/lib145.component';
import { lib1145Routes } from '@ng-bundler-benchmark/lib1145';
...
export const lib145Routes: Route[] = [
    { path: 'lib1145', children: lib1145Routes },
  { path: '', component: Lib145Component },

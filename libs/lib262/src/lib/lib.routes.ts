...
import { Lib262Component } from './lib262/lib262.component';
import { lib1262Routes } from '@ng-bundler-benchmark/lib1262';
...
export const lib262Routes: Route[] = [
    { path: 'lib1262', children: lib1262Routes },
  { path: '', component: Lib262Component },

...
import { Lib100Component } from './lib100/lib100.component';
import { lib1100Routes } from '@ng-bundler-benchmark/lib1100';
...
export const lib100Routes: Route[] = [
    { path: 'lib1100', children: lib1100Routes },
  { path: '', component: Lib100Component },

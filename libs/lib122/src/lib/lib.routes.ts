...
import { Lib122Component } from './lib122/lib122.component';
import { lib1122Routes } from '@ng-bundler-benchmark/lib1122';
...
export const lib122Routes: Route[] = [
    { path: 'lib1122', children: lib1122Routes },
  { path: '', component: Lib122Component },

...
import { Lib223Component } from './lib223/lib223.component';
import { lib1223Routes } from '@ng-bundler-benchmark/lib1223';
...
export const lib223Routes: Route[] = [
    { path: 'lib1223', children: lib1223Routes },
  { path: '', component: Lib223Component },

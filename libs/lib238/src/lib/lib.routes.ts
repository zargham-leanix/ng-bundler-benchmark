...
import { Lib238Component } from './lib238/lib238.component';
import { lib1238Routes } from '@ng-bundler-benchmark/lib1238';
...
export const lib238Routes: Route[] = [
    { path: 'lib1238', children: lib1238Routes },
  { path: '', component: Lib238Component },

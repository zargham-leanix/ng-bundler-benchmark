...
import { Lib225Component } from './lib225/lib225.component';
import { lib1225Routes } from '@ng-bundler-benchmark/lib1225';
...
export const lib225Routes: Route[] = [
    { path: 'lib1225', children: lib1225Routes },
  { path: '', component: Lib225Component },

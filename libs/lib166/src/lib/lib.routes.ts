...
import { Lib166Component } from './lib166/lib166.component';
import { lib1166Routes } from '@ng-bundler-benchmark/lib1166';
...
export const lib166Routes: Route[] = [
    { path: 'lib1166', children: lib1166Routes },
  { path: '', component: Lib166Component },

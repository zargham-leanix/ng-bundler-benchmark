...
import { Lib367Component } from './lib367/lib367.component';
import { lib1367Routes } from '@ng-bundler-benchmark/lib1367';
...
export const lib367Routes: Route[] = [
    { path: 'lib1367', children: lib1367Routes },
  { path: '', component: Lib367Component },

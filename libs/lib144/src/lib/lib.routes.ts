...
import { Lib144Component } from './lib144/lib144.component';
import { lib1144Routes } from '@ng-bundler-benchmark/lib1144';
...
export const lib144Routes: Route[] = [
    { path: 'lib1144', children: lib1144Routes },
  { path: '', component: Lib144Component },

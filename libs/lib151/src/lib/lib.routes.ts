...
import { Lib151Component } from './lib151/lib151.component';
import { lib1151Routes } from '@ng-bundler-benchmark/lib1151';
...
export const lib151Routes: Route[] = [
    { path: 'lib1151', children: lib1151Routes },
  { path: '', component: Lib151Component },

...
import { Lib309Component } from './lib309/lib309.component';
import { lib1309Routes } from '@ng-bundler-benchmark/lib1309';
...
export const lib309Routes: Route[] = [
    { path: 'lib1309', children: lib1309Routes },
  { path: '', component: Lib309Component },

...
import { Lib268Component } from './lib268/lib268.component';
import { lib1268Routes } from '@ng-bundler-benchmark/lib1268';
...
export const lib268Routes: Route[] = [
    { path: 'lib1268', children: lib1268Routes },
  { path: '', component: Lib268Component },

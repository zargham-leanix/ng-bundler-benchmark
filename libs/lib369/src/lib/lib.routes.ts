...
import { Lib369Component } from './lib369/lib369.component';
import { lib1369Routes } from '@ng-bundler-benchmark/lib1369';
...
export const lib369Routes: Route[] = [
    { path: 'lib1369', children: lib1369Routes },
  { path: '', component: Lib369Component },

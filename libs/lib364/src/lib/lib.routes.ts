...
import { Lib364Component } from './lib364/lib364.component';
import { lib1364Routes } from '@ng-bundler-benchmark/lib1364';
...
export const lib364Routes: Route[] = [
    { path: 'lib1364', children: lib1364Routes },
  { path: '', component: Lib364Component },

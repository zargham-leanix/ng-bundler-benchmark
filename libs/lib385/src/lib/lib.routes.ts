...
import { Lib385Component } from './lib385/lib385.component';
import { lib1385Routes } from '@ng-bundler-benchmark/lib1385';
...
export const lib385Routes: Route[] = [
    { path: 'lib1385', children: lib1385Routes },
  { path: '', component: Lib385Component },

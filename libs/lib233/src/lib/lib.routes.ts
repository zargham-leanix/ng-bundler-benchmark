...
import { Lib233Component } from './lib233/lib233.component';
import { lib1233Routes } from '@ng-bundler-benchmark/lib1233';
...
export const lib233Routes: Route[] = [
    { path: 'lib1233', children: lib1233Routes },
  { path: '', component: Lib233Component },

...
import { Lib395Component } from './lib395/lib395.component';
import { lib1395Routes } from '@ng-bundler-benchmark/lib1395';
...
export const lib395Routes: Route[] = [
    { path: 'lib1395', children: lib1395Routes },
  { path: '', component: Lib395Component },

...
import { Lib350Component } from './lib350/lib350.component';
import { lib1350Routes } from '@ng-bundler-benchmark/lib1350';
...
export const lib350Routes: Route[] = [
    { path: 'lib1350', children: lib1350Routes },
  { path: '', component: Lib350Component },

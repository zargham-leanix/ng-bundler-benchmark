...
import { Lib115Component } from './lib115/lib115.component';
import { lib1115Routes } from '@ng-bundler-benchmark/lib1115';
...
export const lib115Routes: Route[] = [
    { path: 'lib1115', children: lib1115Routes },
  { path: '', component: Lib115Component },

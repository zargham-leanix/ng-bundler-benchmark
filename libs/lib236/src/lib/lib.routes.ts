...
import { Lib236Component } from './lib236/lib236.component';
import { lib1236Routes } from '@ng-bundler-benchmark/lib1236';
...
export const lib236Routes: Route[] = [
    { path: 'lib1236', children: lib1236Routes },
  { path: '', component: Lib236Component },

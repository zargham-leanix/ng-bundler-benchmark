...
import { Lib158Component } from './lib158/lib158.component';
import { lib1158Routes } from '@ng-bundler-benchmark/lib1158';
...
export const lib158Routes: Route[] = [
    { path: 'lib1158', children: lib1158Routes },
  { path: '', component: Lib158Component },

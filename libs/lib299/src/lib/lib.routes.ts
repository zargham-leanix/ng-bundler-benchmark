...
import { Lib299Component } from './lib299/lib299.component';
import { lib1299Routes } from '@ng-bundler-benchmark/lib1299';
...
export const lib299Routes: Route[] = [
    { path: 'lib1299', children: lib1299Routes },
  { path: '', component: Lib299Component },

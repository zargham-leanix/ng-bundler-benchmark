...
import { Lib221Component } from './lib221/lib221.component';
import { lib1221Routes } from '@ng-bundler-benchmark/lib1221';
...
export const lib221Routes: Route[] = [
    { path: 'lib1221', children: lib1221Routes },
  { path: '', component: Lib221Component },

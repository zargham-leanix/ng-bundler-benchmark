...
import { Lib98Component } from './lib98/lib98.component';
import { lib1098Routes } from '@ng-bundler-benchmark/lib1098';
...
export const lib98Routes: Route[] = [
    { path: 'lib1098', children: lib1098Routes },
  { path: '', component: Lib98Component },

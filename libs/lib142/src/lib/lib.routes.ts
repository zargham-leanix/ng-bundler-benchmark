...
import { Lib142Component } from './lib142/lib142.component';
import { lib1142Routes } from '@ng-bundler-benchmark/lib1142';
...
export const lib142Routes: Route[] = [
    { path: 'lib1142', children: lib1142Routes },
  { path: '', component: Lib142Component },

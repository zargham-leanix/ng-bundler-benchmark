...
import { Lib162Component } from './lib162/lib162.component';
import { lib1162Routes } from '@ng-bundler-benchmark/lib1162';
...
export const lib162Routes: Route[] = [
    { path: 'lib1162', children: lib1162Routes },
  { path: '', component: Lib162Component },

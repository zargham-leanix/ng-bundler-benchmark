...
import { Lib143Component } from './lib143/lib143.component';
import { lib1143Routes } from '@ng-bundler-benchmark/lib1143';
...
export const lib143Routes: Route[] = [
    { path: 'lib1143', children: lib1143Routes },
  { path: '', component: Lib143Component },

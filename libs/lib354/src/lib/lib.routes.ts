...
import { Lib354Component } from './lib354/lib354.component';
import { lib1354Routes } from '@ng-bundler-benchmark/lib1354';
...
export const lib354Routes: Route[] = [
    { path: 'lib1354', children: lib1354Routes },
  { path: '', component: Lib354Component },

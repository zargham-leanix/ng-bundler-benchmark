...
import { Lib330Component } from './lib330/lib330.component';
import { lib1330Routes } from '@ng-bundler-benchmark/lib1330';
...
export const lib330Routes: Route[] = [
    { path: 'lib1330', children: lib1330Routes },
  { path: '', component: Lib330Component },

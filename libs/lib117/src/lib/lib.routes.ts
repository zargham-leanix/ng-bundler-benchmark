...
import { Lib117Component } from './lib117/lib117.component';
import { lib1117Routes } from '@ng-bundler-benchmark/lib1117';
...
export const lib117Routes: Route[] = [
    { path: 'lib1117', children: lib1117Routes },
  { path: '', component: Lib117Component },

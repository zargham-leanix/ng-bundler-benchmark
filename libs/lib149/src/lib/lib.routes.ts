...
import { Lib149Component } from './lib149/lib149.component';
import { lib1149Routes } from '@ng-bundler-benchmark/lib1149';
...
export const lib149Routes: Route[] = [
    { path: 'lib1149', children: lib1149Routes },
  { path: '', component: Lib149Component },

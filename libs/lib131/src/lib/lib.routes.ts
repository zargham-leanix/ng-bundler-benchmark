...
import { Lib131Component } from './lib131/lib131.component';
import { lib1131Routes } from '@ng-bundler-benchmark/lib1131';
...
export const lib131Routes: Route[] = [
    { path: 'lib1131', children: lib1131Routes },
  { path: '', component: Lib131Component },

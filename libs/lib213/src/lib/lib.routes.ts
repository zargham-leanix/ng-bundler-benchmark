...
import { Lib213Component } from './lib213/lib213.component';
import { lib1213Routes } from '@ng-bundler-benchmark/lib1213';
...
export const lib213Routes: Route[] = [
    { path: 'lib1213', children: lib1213Routes },
  { path: '', component: Lib213Component },

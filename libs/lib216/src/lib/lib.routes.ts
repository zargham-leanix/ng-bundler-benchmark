...
import { Lib216Component } from './lib216/lib216.component';
import { lib1216Routes } from '@ng-bundler-benchmark/lib1216';
...
export const lib216Routes: Route[] = [
    { path: 'lib1216', children: lib1216Routes },
  { path: '', component: Lib216Component },

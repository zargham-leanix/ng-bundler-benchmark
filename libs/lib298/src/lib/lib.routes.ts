...
import { Lib298Component } from './lib298/lib298.component';
import { lib1298Routes } from '@ng-bundler-benchmark/lib1298';
...
export const lib298Routes: Route[] = [
    { path: 'lib1298', children: lib1298Routes },
  { path: '', component: Lib298Component },

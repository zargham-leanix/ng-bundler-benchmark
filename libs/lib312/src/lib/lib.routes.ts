...
import { Lib312Component } from './lib312/lib312.component';
import { lib1312Routes } from '@ng-bundler-benchmark/lib1312';
...
export const lib312Routes: Route[] = [
    { path: 'lib1312', children: lib1312Routes },
  { path: '', component: Lib312Component },

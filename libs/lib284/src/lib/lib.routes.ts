...
import { Lib284Component } from './lib284/lib284.component';
import { lib1284Routes } from '@ng-bundler-benchmark/lib1284';
...
export const lib284Routes: Route[] = [
    { path: 'lib1284', children: lib1284Routes },
  { path: '', component: Lib284Component },

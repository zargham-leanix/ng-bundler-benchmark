...
import { Lib248Component } from './lib248/lib248.component';
import { lib1248Routes } from '@ng-bundler-benchmark/lib1248';
...
export const lib248Routes: Route[] = [
    { path: 'lib1248', children: lib1248Routes },
  { path: '', component: Lib248Component },

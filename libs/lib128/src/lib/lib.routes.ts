...
import { Lib128Component } from './lib128/lib128.component';
import { lib1128Routes } from '@ng-bundler-benchmark/lib1128';
...
export const lib128Routes: Route[] = [
    { path: 'lib1128', children: lib1128Routes },
  { path: '', component: Lib128Component },

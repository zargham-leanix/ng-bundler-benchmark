...
import { Lib136Component } from './lib136/lib136.component';
import { lib1136Routes } from '@ng-bundler-benchmark/lib1136';
...
export const lib136Routes: Route[] = [
    { path: 'lib1136', children: lib1136Routes },
  { path: '', component: Lib136Component },

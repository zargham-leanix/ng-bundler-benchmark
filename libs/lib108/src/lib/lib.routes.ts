...
import { Lib108Component } from './lib108/lib108.component';
import { lib1108Routes } from '@ng-bundler-benchmark/lib1108';
...
export const lib108Routes: Route[] = [
    { path: 'lib1108', children: lib1108Routes },
  { path: '', component: Lib108Component },

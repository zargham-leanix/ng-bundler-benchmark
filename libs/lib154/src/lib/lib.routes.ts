...
import { Lib154Component } from './lib154/lib154.component';
import { lib1154Routes } from '@ng-bundler-benchmark/lib1154';
...
export const lib154Routes: Route[] = [
    { path: 'lib1154', children: lib1154Routes },
  { path: '', component: Lib154Component },

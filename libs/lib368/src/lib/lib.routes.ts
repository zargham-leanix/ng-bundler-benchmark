...
import { Lib368Component } from './lib368/lib368.component';
import { lib1368Routes } from '@ng-bundler-benchmark/lib1368';
...
export const lib368Routes: Route[] = [
    { path: 'lib1368', children: lib1368Routes },
  { path: '', component: Lib368Component },

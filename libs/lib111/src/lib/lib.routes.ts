...
import { Lib111Component } from './lib111/lib111.component';
import { lib1111Routes } from '@ng-bundler-benchmark/lib1111';
...
export const lib111Routes: Route[] = [
    { path: 'lib1111', children: lib1111Routes },
  { path: '', component: Lib111Component },

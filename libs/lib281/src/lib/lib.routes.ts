...
import { Lib281Component } from './lib281/lib281.component';
import { lib1281Routes } from '@ng-bundler-benchmark/lib1281';
...
export const lib281Routes: Route[] = [
    { path: 'lib1281', children: lib1281Routes },
  { path: '', component: Lib281Component },

...
import { Lib322Component } from './lib322/lib322.component';
import { lib1322Routes } from '@ng-bundler-benchmark/lib1322';
...
export const lib322Routes: Route[] = [
    { path: 'lib1322', children: lib1322Routes },
  { path: '', component: Lib322Component },

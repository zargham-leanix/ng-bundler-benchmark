...
import { Lib254Component } from './lib254/lib254.component';
import { lib1254Routes } from '@ng-bundler-benchmark/lib1254';
...
export const lib254Routes: Route[] = [
    { path: 'lib1254', children: lib1254Routes },
  { path: '', component: Lib254Component },

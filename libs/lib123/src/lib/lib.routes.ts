...
import { Lib123Component } from './lib123/lib123.component';
import { lib1123Routes } from '@ng-bundler-benchmark/lib1123';
...
export const lib123Routes: Route[] = [
    { path: 'lib1123', children: lib1123Routes },
  { path: '', component: Lib123Component },

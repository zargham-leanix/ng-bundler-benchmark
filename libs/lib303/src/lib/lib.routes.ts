...
import { Lib303Component } from './lib303/lib303.component';
import { lib1303Routes } from '@ng-bundler-benchmark/lib1303';
...
export const lib303Routes: Route[] = [
    { path: 'lib1303', children: lib1303Routes },
  { path: '', component: Lib303Component },

...
import { Lib176Component } from './lib176/lib176.component';
import { lib1176Routes } from '@ng-bundler-benchmark/lib1176';
...
export const lib176Routes: Route[] = [
    { path: 'lib1176', children: lib1176Routes },
  { path: '', component: Lib176Component },

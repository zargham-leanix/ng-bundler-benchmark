...
import { Lib283Component } from './lib283/lib283.component';
import { lib1283Routes } from '@ng-bundler-benchmark/lib1283';
...
export const lib283Routes: Route[] = [
    { path: 'lib1283', children: lib1283Routes },
  { path: '', component: Lib283Component },

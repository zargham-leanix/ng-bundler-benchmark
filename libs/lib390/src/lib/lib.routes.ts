...
import { Lib390Component } from './lib390/lib390.component';
import { lib1390Routes } from '@ng-bundler-benchmark/lib1390';
...
export const lib390Routes: Route[] = [
    { path: 'lib1390', children: lib1390Routes },
  { path: '', component: Lib390Component },

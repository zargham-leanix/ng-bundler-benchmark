...
import { Lib182Component } from './lib182/lib182.component';
import { lib1182Routes } from '@ng-bundler-benchmark/lib1182';
...
export const lib182Routes: Route[] = [
    { path: 'lib1182', children: lib1182Routes },
  { path: '', component: Lib182Component },

...
import { Lib279Component } from './lib279/lib279.component';
import { lib1279Routes } from '@ng-bundler-benchmark/lib1279';
...
export const lib279Routes: Route[] = [
    { path: 'lib1279', children: lib1279Routes },
  { path: '', component: Lib279Component },

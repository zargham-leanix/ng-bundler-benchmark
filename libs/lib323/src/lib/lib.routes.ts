...
import { Lib323Component } from './lib323/lib323.component';
import { lib1323Routes } from '@ng-bundler-benchmark/lib1323';
...
export const lib323Routes: Route[] = [
    { path: 'lib1323', children: lib1323Routes },
  { path: '', component: Lib323Component },

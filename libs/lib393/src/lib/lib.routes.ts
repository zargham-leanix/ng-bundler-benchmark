...
import { Lib393Component } from './lib393/lib393.component';
import { lib1393Routes } from '@ng-bundler-benchmark/lib1393';
...
export const lib393Routes: Route[] = [
    { path: 'lib1393', children: lib1393Routes },
  { path: '', component: Lib393Component },

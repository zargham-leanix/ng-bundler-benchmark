...
import { Lib126Component } from './lib126/lib126.component';
import { lib1126Routes } from '@ng-bundler-benchmark/lib1126';
...
export const lib126Routes: Route[] = [
    { path: 'lib1126', children: lib1126Routes },
  { path: '', component: Lib126Component },

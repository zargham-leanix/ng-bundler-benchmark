...
import { Lib264Component } from './lib264/lib264.component';
import { lib1264Routes } from '@ng-bundler-benchmark/lib1264';
...
export const lib264Routes: Route[] = [
    { path: 'lib1264', children: lib1264Routes },
  { path: '', component: Lib264Component },

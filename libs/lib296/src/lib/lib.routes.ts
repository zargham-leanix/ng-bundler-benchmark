...
import { Lib296Component } from './lib296/lib296.component';
import { lib1296Routes } from '@ng-bundler-benchmark/lib1296';
...
export const lib296Routes: Route[] = [
    { path: 'lib1296', children: lib1296Routes },
  { path: '', component: Lib296Component },

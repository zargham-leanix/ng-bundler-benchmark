...
import { Lib161Component } from './lib161/lib161.component';
import { lib1161Routes } from '@ng-bundler-benchmark/lib1161';
...
export const lib161Routes: Route[] = [
    { path: 'lib1161', children: lib1161Routes },
  { path: '', component: Lib161Component },

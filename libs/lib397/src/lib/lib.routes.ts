...
import { Lib397Component } from './lib397/lib397.component';
import { lib1397Routes } from '@ng-bundler-benchmark/lib1397';
...
export const lib397Routes: Route[] = [
    { path: 'lib1397', children: lib1397Routes },
  { path: '', component: Lib397Component },

...
import { Lib246Component } from './lib246/lib246.component';
import { lib1246Routes } from '@ng-bundler-benchmark/lib1246';
...
export const lib246Routes: Route[] = [
    { path: 'lib1246', children: lib1246Routes },
  { path: '', component: Lib246Component },

...
import { Lib110Component } from './lib110/lib110.component';
import { lib1110Routes } from '@ng-bundler-benchmark/lib1110';
...
export const lib110Routes: Route[] = [
    { path: 'lib1110', children: lib1110Routes },
  { path: '', component: Lib110Component },

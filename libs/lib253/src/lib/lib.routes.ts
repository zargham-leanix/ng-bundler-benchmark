...
import { Lib253Component } from './lib253/lib253.component';
import { lib1253Routes } from '@ng-bundler-benchmark/lib1253';
...
export const lib253Routes: Route[] = [
    { path: 'lib1253', children: lib1253Routes },
  { path: '', component: Lib253Component },

...
import { Lib139Component } from './lib139/lib139.component';
import { lib1139Routes } from '@ng-bundler-benchmark/lib1139';
...
export const lib139Routes: Route[] = [
    { path: 'lib1139', children: lib1139Routes },
  { path: '', component: Lib139Component },

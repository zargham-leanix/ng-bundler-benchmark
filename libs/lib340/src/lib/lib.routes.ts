...
import { Lib340Component } from './lib340/lib340.component';
import { lib1340Routes } from '@ng-bundler-benchmark/lib1340';
...
export const lib340Routes: Route[] = [
    { path: 'lib1340', children: lib1340Routes },
  { path: '', component: Lib340Component },

...
import { Lib107Component } from './lib107/lib107.component';
import { lib1107Routes } from '@ng-bundler-benchmark/lib1107';
...
export const lib107Routes: Route[] = [
    { path: 'lib1107', children: lib1107Routes },
  { path: '', component: Lib107Component },

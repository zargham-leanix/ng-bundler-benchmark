...
import { Lib336Component } from './lib336/lib336.component';
import { lib1336Routes } from '@ng-bundler-benchmark/lib1336';
...
export const lib336Routes: Route[] = [
    { path: 'lib1336', children: lib1336Routes },
  { path: '', component: Lib336Component },
